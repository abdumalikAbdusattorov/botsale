...
@connect(({app, customer}) => ({app, customer}))
class Index extends Component {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'customer/getByPageableCustomer',
      payload: {
        page: 0,
        size: 10
      }
  ...
  render() {
    const {dispatch, app, customer} = this.props
    console.log(this.props, "PROPS====================")
    const {customerPage, customerTotalElements} = customer
        ...
        <Row>
          <Col>
            <Pagination
              ...
              totalItemsCount={customerTotalElements}
