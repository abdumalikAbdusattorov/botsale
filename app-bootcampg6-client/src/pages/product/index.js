...
class Index extends Component {
  ...
  render() {
    ...
    const changeEnabled = (id, active) => {
      console.log(id, active, "mana product ")
      dispatch({
        type: 'product/changeActive',
        payload: {
          id,
          active
        }
                  ...
                  <tr>
                    ...
                    <td>
                      <div style={{width: "40px", height: "40px"}}>
                        <img
                          src={item.photoId ? "http://localhost:8082/api/file/" + item.photoId : ''} alt=""
                          className="img-fluid"/>
                      </div>
                    </td>
                    <td>{item.nameUz}</td>
                    ...
                    {/*{console.log(item,"Mana Itemmmmmmmm")}*/}
                    <td>
                      <Button color="warning" onClick={() => editProduct(item)}>Edit</Button>
                    </td>
                    <td><Button color="danger" onClick={() => deleteProduct(item.id)}>Delete</Button></td>
            ...
            <ModalBody>
              <div>
                ...
                <div style={{width: "200px", height: "200px"}}><img
                  src={this.state.tempPhotoId ? "http://localhost:8082/api/file/" + this.state.tempPhotoId : ''} alt=""
