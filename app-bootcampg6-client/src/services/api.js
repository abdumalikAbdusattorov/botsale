export default {
  ...
  getAllPayType:'/payType',
  getAllPayTypes:'/payType/getAllPayTypes',
  saveOrEditPayType:'POST /payType',
  deletePayType:'DELETE /payType/',
  blockOrActivatePayType:'/payType/blockOrActivate',

  saveOrEditCustomer:'POST /customer',
  deleteCustomer:'DELETE /customer/',
  blockOrActivateCustomer:'/customer/activateOrBlock',
  getByPageableCustomer:'/customer/byPageable',
